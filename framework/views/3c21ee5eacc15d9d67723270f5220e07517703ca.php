...
unset($__errorArgs, $__bag); ?>" id="app_name"
                           placeholder="App name" value="<?php echo e(old('app_name', config('settings.app_name'))); ?>">
...
unset($__errorArgs, $__bag); ?>" id="app_description"
                              placeholder="App description"><?php echo e(old('app_description', config('settings.app_description'))); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="currency_symbol"
                           placeholder="Currency symbol" value="<?php echo e(old('currency_symbol', config(''))); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Ori Laundry\resources\views/settings/edit.blade.php ENDPATH**/ ?>