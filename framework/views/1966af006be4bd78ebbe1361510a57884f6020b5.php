    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item has-treeview">
                    <a href="<?php echo e(route('outlets.index')); ?>" class="nav-link <?php echo e(activeSegment('outlets')); ?>">
...
<?php /**PATH C:\wamp64\www\shopee-laravel\Ori Laundry\resources\views/layouts/partials/sidebar.blade.php ENDPATH**/ ?>