...
@section('content-header', 'Laundry Type')
@section('content-actions')
<a href="{{route('products.create')}}" class="btn btn-primary">Create Laundry Type</a>
@endsection
@section('css')
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('products.show', $product) }}" class="btn btn-success"><i
