...
class Cart extends Component {
    ...
    render() {
        ...
        return ( <
                ...
                customers.map(cus => ( <
                    option key = { cus.id }
                    value = { cus.id } > { `${cus.first_name} ${cus.last_name}` } < /option>
                ))
            } <
            /select> < /
        div > <
        ...
        tbody > {
                cart.map(c => ( <
                    ...
                    button > <
                    /td> <
                    td className = "text-right" > { window.APP.currency_symbol } { " " } {
                        (
        ...
        div className = "col text-right" > { window.APP.currency_symbol } { this.getTotal(cart) } <
            /div> < /
        div > <
            div className = "row" >
            <
        ...
        div > <
            ...
            input type = "text"
        className = "form-control"
        placeholder = "Search Laundry Type..."
